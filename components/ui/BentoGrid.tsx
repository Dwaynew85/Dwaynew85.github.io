...
export const BentoGridItem = ({
  ...
  const leftList = ['Go', 'React.js', 'TypeScript']
  const rightList = ['Python', 'Next.js', 'Java']
  ...
  return (
    ...
    >
      <div className={`${id === 6 && 'flex justify-center'} h-full`}>
        ...
        <div className={cn(titleClassName, 'group-hove/bento:translate-x-2 transition duration-200 relative md:h-full min-h-40 flex flex-col px-5 p-5 lg:p-5')}>
